...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"cashcoreaddress\"\n"
            "\nReveals the private key corresponding to 'cashcoreaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"cashcoreaddress\"   (string, required) The cashcore address for the private key\n"
            "\nResult:\n"
