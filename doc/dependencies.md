...
These are the dependencies currently used by CashCore. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/cashcorenl
Keybase  - https://keybase.io/team/cashcore/
