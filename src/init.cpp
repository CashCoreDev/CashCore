...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/DeflacashV2/CashCore>";
    const std::string URL_WEBSITE = "<https://deflacash.com//>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The CashCore Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find CashCore useful. "
