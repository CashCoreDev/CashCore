...
const QString BITCOIN_IPC_PREFIX("cashcore:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/cashcore-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/cashcore-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/cashcore-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click cashcore: links
...
//
// OSX-specific way of handling cashcore: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in cashcore: URIs
